...
(function (global, factory) {
	...
	*/
    ...
    var wellKnownSymbol = function (name) {
        return (
            store$1[name] ||
            (store$1[name] = (nativeSymbol && Symbol$1[name]) || (nativeSymbol ? Symbol$1 : uid)('Symbol.' + name))
        );
    };
            ...
            Array.prototype.forEach.call(mutation.addedNodes, function (addedNode) {
                if (addedNode.nodeType === 1) {
                    if (addedNode.hasAttribute('data-simplebar')) {
                        ...
                        Array.prototype.forEach.call(
                            addedNode.querySelectorAll('[data-simplebar]:not([data-simplebar="init"])'),
                            function (el) {
            ...
            Array.prototype.forEach.call(mutation.removedNodes, function (removedNode) {
                if (removedNode.nodeType === 1) {
                    if (removedNode.hasAttribute('[data-simplebar="init"]')) {
                        ...
                        Array.prototype.forEach.call(removedNode.querySelectorAll('[data-simplebar="init"]'), function (
                            el
                        ) {
